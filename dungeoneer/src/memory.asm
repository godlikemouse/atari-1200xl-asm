...
LEVEL_MAPL        = $00d8 ; game level map low byte
LEVEL_MAPH        = $00d9 ; game level map high byte
LEVEL_INTROL      = $00da ; game level intro map low byte
LEVEL_INTROH      = $00db ; game level intro map high byte
NEXT_LEVELL       = $00dc ; next level proc low byte
NEXT_LEVELH       = $00dd ; next level proc high byte
